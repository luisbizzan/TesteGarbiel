...
namespace FWLog.Services.Services
{
    public class RepresentanteService : BaseService
    {
        ...
        public async Task ConsultarRepresentante()
        {
            ...
            List<RepresentanteIntegracao> representantesIntegracao = await IntegracaoSankhya.Instance.PreExecutarQuery<RepresentanteIntegracao>(where: where.ToString(),inner: inner);
