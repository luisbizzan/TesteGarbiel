(function () {
    ...
    $("#editarCaixaRecusa").click(function () {
        editarCaixaRecusa();
    });
...
function editarCaixaRecusa() {
    ...
    $.ajax({
        url: HOST_URL + CONTROLLER_PATH + "Editar",
        method: "POST",
        ...
        error: function (data) {
            PNotify.error({ text: "Ocorreu um erro para editar a caixa e os produtos de recusa." });
            NProgress.done();
        }
    });
}
